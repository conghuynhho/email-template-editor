...
const Style = props => {
    ...
    useEffect(() => {
        try {
            const type = 'TEXT';
            const newConfig = sidePanelConfig.find(item => item.type === type);
                    ...
                    return (
                        <div key={item.id}>
                            <div className="section">
                                ...
                                <div className='section-container pl-15 mb-15' style={{display: 'flex', flexWrap: 'wrap'}}>
